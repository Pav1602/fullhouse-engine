...
class Config:
    ...
    equity_thin_value: float = 0.4770665192555191       # thin value-bet IP only
    equity_call_threshold: float = 0.3919811186191172   # marginal call threshold
    equity_raise_threshold: float = 0.7687326130974848  # raise instead of just call
    pot_odds_buffer_normal: float = 0.1014539537201927  # extra equity required vs pot odds
    ...
    fourbet_call_threshold_pct: float = 0.1351630858370252       # cap on calling 3-bets out-of-position
    threebet_call_threshold_pct: float = 0.2170225254829958      # cap on calling raises with weaker hands

    # --- C-bet (continuation bet) ---
    cbet_freq_base: float = 0.6359670747418533
    ...
    # --- Bluff frequencies ---
    bluff_freq_ip: float = 0.05223860805977661
    bluff_freq_oop: float = 0.03942295665836069
