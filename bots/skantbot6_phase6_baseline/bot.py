...
class Config:
    ...
    k_texture_high_card: float = 0.0
    spr_commit_threshold: float = 4.0
    spr_smoothness: float = 2.0
    k_commit: float = 0.0
    river_mdf_aggression: float = 1.0
    river_v2b_half_pot: float = 2.0
    river_v2b_pot_sized: float = 1.0
    river_v2b_overbet: float = 0.5
    k_river_bluff_blocker: float = 0.0
    river_value_thin_threshold: float = 0.62
    river_value_strong_threshold: float = 0.80
    ...
    # --- Opponent modelling ---
    k_bluff_vs_cbet_folder: float = 0.0
    k_bluff_vs_2barrel_folder: float = 0.0
    k_bluff_vs_3barrel_folder: float = 0.0
    k_bluff_vs_wtsd: float = 0.0
    k_value_size_vs_station: float = 0.0
    k_tightness_vs_3bet_freq: float = 0.0
    k_call_threshold_vs_aggression: float = 0.0
    k_4bet_vs_3bet_freq: float = 0.0
    ...
    if can_check:
        ...
        if was_pf_aggressor and street in ("turn", "river") and eq < cfg.equity_thin_value and not facing_station:
            ...
            if opp_profile is not None:
                ...
                barrel_freq *= 1.0 - cfg.k_bluff_vs_wtsd * max(0, opp_profile.stat("vpip") - 0.3)
        ...
        if opp_profile is not None:
            bluff_freq *= 1.0 - cfg.k_bluff_vs_wtsd * max(0, opp_profile.stat("vpip") - 0.3)
